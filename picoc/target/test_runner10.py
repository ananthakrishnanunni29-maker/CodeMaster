...
try:
    ...
    print("Parsing StdioDefs...", flush=True)
    ParseModule.PicocParse(pc, "stdio.h", StdioDefs, len(StdioDefs), True, True, False, False)
    print("StdioDefs parsed OK", flush=True)
    
    print("Testing LibraryAdd...", flush=True)
